            ...
            <Container>
                ...
                {products.length > 0 && (
                    <>
                        ...
                        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-xl border border-slate-200/60 p-3 px-6 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] flex justify-between items-center rounded-2xl w-[92%] md:w-[600px] z-[1000] transition-all">
                            <div className="flex flex-col">
                                <span className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-0.5">
                                    Total Amount
                                </span>
                                <h4 className="mb-0 m-0 font-extrabold text-2xl text-slate-800 tracking-tight">
                                    {t("cart.total_egp")} {total}
                                </h4>
                            </div>
                            <button
                ...
                >
                    ...
                    >
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M19 7v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7m14 0V5a2 2 0 00-2-2H7a2 2 0 00-2 2v2m14 0H5m0 0l2-3m8 3l-2-3"
                        />
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
